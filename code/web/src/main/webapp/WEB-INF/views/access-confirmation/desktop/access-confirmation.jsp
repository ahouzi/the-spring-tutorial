...
<div id="content">
    ...
    <authz:authorize ifAllGranted="ROLE_USER">
        ...
        <form id="confirmationForm" name="confirmationForm" action="${context}/oauth/authorize" method="post">
            <input name="user_oauth_approval" value="true" type="hidden"/>
            <label><input name="authorize" value="Authorize" type="submit"></label>
        </form>
        <form id="denialForm" name="denialForm" action="${context}/oauth/authorize" method="post">
