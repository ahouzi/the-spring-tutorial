    ...
    <tiles:insertTemplate template="/WEB-INF/layouts/components/box.jsp">
        <tiles:putAttribute name="content">
            <form name="form" class="form-horizontal" method="POST"
                  action="${pageContext.request.contextPath}/crm/signin.html">
                <div class="panel">
                    <fieldset>
                        ...
                        <div class="control-group ${cgClass}">
                            ...
                            <div class="controls">
                                ...
                                <input class="input-xlarge" id="username" name="username" type="text" ng-model="user.username" required="required"/>
                        ...
                        <div class="control-group ${cgClass}">
                            ...
                            <div class="controls">
                                <input class="input-xlarge" id="password" name="password" type="password" ng-model="user.password" required="required"/>
